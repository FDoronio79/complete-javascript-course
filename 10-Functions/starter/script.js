...
// refactor of the above to use a function that returns a function
...
/*
    ...
    // by wrapping the function in parentheses we transfrom the function expression to an expression and call it at the end with the ();
    // this is also known as IIFE
    (function() {
...
console.log('Reassign f function');
h();
f();
...
const poll = {
    ...
    // #1
    registerNewAnswer() {
        // #1.1 Prompt to get answer
        const answer = Number(
            prompt(`${this.question}\n${this.options.join('\n')}\n(Write option number)`),
        );
        console.log(answer);

        // #1.2 Update answers array
...
// #2 Call the function when the poll button is clicked and bind the function to the poll object
